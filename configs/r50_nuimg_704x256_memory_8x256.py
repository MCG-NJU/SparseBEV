    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Collect3D', keys=['img']+  collect_keys, meta_keys=(
                ...
                'lidar2img', 'img_timestamp', 'scene_token', 'timestamp', 'ego_pose', 'ego_pose_inv'))
        ])
]
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=dataset_root + 'nuscenes_infos_train_sweep_temporal.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=dataset_root,
        ann_file=dataset_root + 'nuscenes_infos_val_sweep_temporal.pkl',
